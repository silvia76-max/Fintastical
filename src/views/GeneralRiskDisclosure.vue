<template>
  <div class="general-container">
    ...
    <h2>Execution</h2>
    <p>Although the Fintastical trading platform is automated, and we give you the best execution available, it is possible that the market price could have changed between order placement and execution time, and, therefore, we cannot guarantee that the price requested will be the same as the price at which the order is executed, therefore, the price you receive can be in your favour or against you.</p>
    ...
    <p>You can read more about copy trading risks <a href="#">here</a>.</p>
    ...
    <p><strong>ACCORDINGLY, CRYPTOCURRENCIES SHOULD BE SEEN AS AN EXTREMELY HIGH-RISK ASSET AND YOU SHOULD NEVER INVEST FUNDS THAT YOU CANNOT AFFORD TO LOSE.</strong></p>
    ...
    <p>Fintastical currently allows trading in cryptocurrencies over the weekend and it reserves the right not to do so. Should Fintastical so elect, trading in cryptocurrencies shall be allowed only from Monday through Friday. Given that the Cryptocurrency exchanges may operate over weekends, there may be a significant difference between Friday’s close and Sunday’s open. All such factors may result in you either not completing an order on a specific trading day or completing an order on a substantially less favourable price.</p>

    <p>Under certain market conditions, you may find it difficult or impossible to liquidate a position. This can occur, for example, when the market reaches a daily price fluctuation limit (“limit move”), if there is insufficient liquidity in the market.</p>

    <h3>Blockchain Risks</h3>
    <p>Since blockchain is an independent public peer-to peer network and is not controlled in any way or manner by Fintastical, Fintastical shall not be responsible for any failure and/or mistake and/or error and/or breach which shall occur in blockchain or in any other networks in which the Cryptocurrencies are being issued and/or traded. You will be bound and subject to any change and/or amendments in the blockchain system and subject to any applicable law which may apply to the blockchain. We make no representation or warranty of any kind, express or implied, statutory or otherwise, regarding the blockchain functionality nor for any breach of security in the blockchain.</p>

    <h3>Operation of Cryptocurrency Protocols</h3>
    <p>Fintastical does not own or control the underlying software protocols which govern the operation of Cryptocurrencies available for trading on our platform. In general, the underlying protocols are open source and anyone can use, copy, modify, and distribute them. Fintastical is not responsible for the operation of the underlying protocols and Fintastical makes no guarantee of their functionality, security, or availability. The underlying protocols are subject to sudden changes in operating rules (“Forks”), and such Forks may materially affect the value, function, and/or even the name of the Cryptocurrency Fintastical holds for your benefit. In the event of a Fork, Fintastical may temporarily suspend Fintastical operations (with or without advance notice) and Fintastical may (a) configure or reconfigure its systems or (b) decide not to support (or cease supporting) the Forked protocol entirely. Fintastical may, but is not obligated to do so, adjust your account in respect of a Fork, depending on the circumstances of each event attributable to any specific Cryptocurrency which you hold.</p>

    <h3>Third-party Risks</h3>
    <p>We may elect to execute any order and/or hold any fiat money and cryptocurrencies via a Third Party. Such Third Parties are not banks that hold their fiat money/virtual currency as a deposit. If any such Third Party loses any money, fails or goes out of business, there is no specific legal protection that covers you for losses arising from any funds you may have held with such a Third Party, even when such party is registered with a national authority. Depending on the structure and security of the Fintastical Money crypto wallet, some individuals may be vulnerable to hacks, resulting in the theft of virtual currency or loss of customer assets. Fintastical will not be responsible in the event of losses caused by those Third Parties.</p>

    <h3>Delisting and/or Unsupported Cryptocurrencies</h3>
    <p>If at any time any of the Cryptocurrencies from the subject of your order are delisted and/or we no longer support the trading in such Cryptocurrencies for any reason, then the applicable order will be immediately closed. If Fintastical is notified that a Cryptocurrency you hold in your account is likely to be delisted and/or removed and/or cancelled from any of the exchanges (some of them or all) and Fintastical believes that it shall not be able to trade in such Cryptocurrencies, Fintastical shall make an effort to sell the Cryptocurrencies on your behalf at such time and price, and in such manner, as it determines.</p>

    <h2>Automated Trading & Internet Risks</h2>
